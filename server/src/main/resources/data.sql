...
-- 正在傾印表格  airegistry_test.auditlog 的資料：~141 rows (近似值)
...
INSERT INTO `auditlog` (`sequence`, `query`, `timestamp`, `sourceIP`, `sourceAccount`) VALUES
	...
	(363, 'UPDATE detail SET detailDesc=\'English detail\',detailName_TC=\'TC Detail\',detailName_SC=\'SC Detail\' WHERE detailID = 4', '2022-02-18 20:56:56', 'localhost:65386', 'root'),
	(364, 'UPDATE detail SET detailDesc=\'English detail\',detailDesc_TC=\'TC Detail\',detailDesc_SC=\'SC Detail\' WHERE detailID = 4', '2022-02-18 20:59:08', 'localhost:65386', 'root'),
	(365, 'UPDATE detail SET detailName=\'English detail\',detailDesc_TC=\'TC Detail\',detailDesc_SC=\'SC Detail\' WHERE detailID = 4', '2022-02-18 20:59:47', 'localhost:65386', 'root'),
	(531, 'UPDATE ATTACHMENT SET\ndeleted = NOW()\nWHERE attachmentID = 10', '2022-02-21 19:52:06', 'localhost:52059', 'root'),
	(532, 'INSERT INTO `attachment`\n(`filename`,`orig_filename`,`orig_ext`,`detailId`, `projectId`)\nVALUES\n(\'\',\'test\',\'abc\',1,15)', '2022-02-21 19:52:06', 'localhost:52063', 'root'),
	(533, 'INSERT INTO `attachment`\n(`filename`,`orig_filename`,`orig_ext`,`projectId`)\nVALUES\n(\'\',\'test\',\'abc\',15)', '2022-02-21 19:52:06', 'localhost:52064', 'root'),
	(534, 'UPDATE ATTACHMENT SET\ndeleted = NOW()\nWHERE attachmentID = 10', '2022-02-21 19:54:15', 'localhost:52135', 'root'),
	(535, 'INSERT INTO `attachment`\n(`filename`,`orig_filename`,`orig_ext`,`detailId`, `projectId`)\nVALUES\n(\'\',\'test\',\'abc\',1,15)', '2022-02-21 19:54:15', 'localhost:52141', 'root'),
	(536, 'INSERT INTO `attachment`\n(`filename`,`orig_filename`,`orig_ext`,`projectId`)\nVALUES\n(\'\',\'test\',\'abc\',15)', '2022-02-21 19:54:15', 'localhost:52142', 'root'),
	(537, 'UPDATE ATTACHMENT SET\ndeleted = NOW()\nWHERE attachmentID = 10', '2022-02-21 19:54:51', 'localhost:52179', 'root'),
	(539, 'UPDATE attachment SET deleted = NULL WHERE attachment.attachmentID = 10', '2022-02-21 19:57:58', 'localhost:65386', 'root');
...
INSERT INTO `detail` (`projectID`, `detailID`, `detailName`, `detailDesc`, `detailName_TC`, `detailDesc_TC`, `detailDesc_SC`, `deleted`, `detailName_SC`) VALUES
	...
	(15, 4, 'English detail', 'English detail', 'TC Detail', 'TC Detail', 'SC Detail', NULL, 'SC Detail');
