...
-- 正在傾印表格  airegistry.attachment 的資料：~5 rows (近似值)
...
-- 正在傾印表格  airegistry.auditlog 的資料：~128 rows (近似值)
...
INSERT INTO `auditlog` (`sequence`, `query`, `timestamp`, `sourceIP`, `sourceAccount`) VALUES
	...
	(155, 'INSERT INTO `Tag` (`projectId`,`tag`,`tag_TC`,`tag_SC`)\n    VALUES\n    (15,\'test\',\'測試\',\'測試\')', '2022-02-26 00:23:45', 'localhost:61530', 'root'),
	(156, 'DELETE FROM `Tag` WHERE projectId = 15 AND `tag` = \'T\'', '2022-02-26 00:25:01', 'localhost:61529', 'root'),
	(157, 'INSERT INTO `Tag` (`projectId`,`tag`,`tag_TC`,`tag_SC`)\n    VALUES\n    (15,\'T\',\'TT\',\'TTT\')', '2022-02-26 00:29:00', 'localhost:61531', 'root'),
	(158, 'INSERT INTO user\n(username, firstName, lastName, userType, password, salt, email)\nVALUES (\'admin10\', \'admin\', \'admin\', \'admin\',\n\'$2a$10$wp7gzeOpZqKRyRtmkMnuPuc7nFzZYhBLIM2iRYpSv46v3ozZmshi2\', \'\', \'mic4126@gmail.com\')', '2022-02-26 01:32:32', 'localhost:53120', 'root'),
	(159, 'UPDATE user SET\nnew_password = \'$2a$10$PmPHONYJFYX8kHn9D1u3lOYWaKqfZOrwvK0bIpcfzxpaXI5PtRGQO\',\nnew_salt = \'\'\nWHERE\nusername = \'admin5\'\nAND email = \'mic4126@gmail.com\'', '2022-02-26 02:36:50', 'localhost:57336', 'root'),
	(160, 'UPDATE user SET\npassword = \'$2a$10$Repz3HeiDk0YSlSQAyZla.S9m1aXGUPFRvhwxbAyUF8Dp558aH7vm\',\nsalt = \'\',\nnew_password = NULL,\nnew_salt = NULL\nWHERE\nusername = \'admin\'', '2022-02-26 02:46:47', 'localhost:57337', 'root'),
	(161, 'UPDATE user SET\nfirstName = \'nimda\',\nlastName = \'1234\',\nemail = \'mic4126@gmail.com\'\nWHERE\nusername = \'admin\'', '2022-02-26 03:00:18', 'localhost:57338', 'root'),
	(162, 'UPDATE `detail` SET\n`detailName` = \'Test Detail\',\n`detailDesc` = \'TestTESTTTTTTT\',\n`detailName_TC` = \'測試\',\n`detailDesc_TC` = \'測試測試測試測試\',\n`detailName_SC` = \'測試\',\n`detailDesc_SC` = \'測試\'\nWHERE `detailId` = 1', '2022-02-28 02:58:11', 'localhost:52885', 'root'),
	(163, 'UPDATE user SET\npassword = \'$2a$10$6RaLq6FQzKPXeyJzmNlcXekAjd30cwo0r.u4qJu56e2lb3V8Iax1K\',\nsalt = \'\',\nnew_password = NULL,\nnew_salt = NULL\nWHERE\nusername = \'dev\'', '2022-03-06 03:33:39', 'localhost:49937', 'root'),
	(164, 'UPDATE user SET\npassword = \'$2a$10$/i/wKF6oWHIuJE1of6KrDeMpYw12nEzw1C0MgxFpxbokQD3pnl55G\',\nsalt = \'\',\nnew_password = NULL,\nnew_salt = NULL\nWHERE\nusername = \'dev\'', '2022-03-06 03:36:56', 'localhost:49937', 'root'),
	(165, 'INSERT INTO `Detail` (`projectId`,`detailName`)\nVALUES\n(15,\'Testtt\')', '2022-03-14 01:00:14', 'localhost:63298', 'root'),
	(166, 'UPDATE `detail` SET\n`deleted` = Now()\nWHERE `detailId` = 5', '2022-03-14 01:00:19', 'localhost:63298', 'root'),
	(167, 'UPDATE `detail` SET\n`detailName` = \'Testtt\',\n`detailDesc` = NULL,\n`detailName_TC` = NULL,\n`detailDesc_TC` = NULL,\n`detailName_SC` = NULL,\n`detailDesc_SC` = NULL\nWHERE `detailId` = 5', '2022-03-14 01:00:19', 'localhost:63296', 'root');
...
-- 正在傾印表格  airegistry.detail 的資料：~4 rows (近似值)
DELETE FROM `detail`;
...
INSERT INTO `detail` (`projectID`, `detailID`, `detailName`, `detailDesc`, `detailName_TC`, `detailDesc_TC`, `detailDesc_SC`, `deleted`, `detailName_SC`) VALUES
	...
	(15, 5, 'Testtt', NULL, NULL, NULL, NULL, '2022-03-14 01:00:19', NULL);
...
-- 正在傾印表格  airegistry.project 的資料：~5 rows (近似值)
DELETE FROM `project`;
...
INSERT INTO `project` (`projectID`, `projectName`, `desc`, `email`, `phoneNumber`, `department`, `projectName_TC`, `projectName_SC`, `desc_TC`, `desc_SC`, `deleted`, `url`, `department_TC`, `department_SC`, `enabled`) VALUES
	(15, '測試測試', 'Lorem_ipsum', 'ab.com@abc.com', '12345678', '321', '測試', '測試測試', '繁中測試', '簡中簡中簡中', NULL, 'example.com', '123', '456', NULL),
	(16, 'test1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	(18, 'test2', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	(19, 'test5', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	(20, 'test3', 'test projectID 20 eng', NULL, NULL, NULL, NULL, NULL, 'test projectID 20 tc', 'test projectID 20 sc', NULL, NULL, NULL, NULL, NULL),
	(21, 'TESTPROJECT', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
-- 正在傾印表格  airegistry.project_user 的資料：~10 rows (近似值)
...
-- 正在傾印表格  airegistry.tag 的資料：~2 rows (近似值)
DELETE FROM `tag`;
...
-- 正在傾印表格  airegistry.user 的資料：~9 rows (近似值)
DELETE FROM `user`;
...
INSERT INTO `user` (`username`, `firstName`, `lastName`, `userType`, `password`, `salt`, `new_password`, `new_salt`, `delete_date`, `email`) VALUES
	('admin', 'nimda', '1234', 'admin', '$2a$10$Repz3HeiDk0YSlSQAyZla.S9m1aXGUPFRvhwxbAyUF8Dp558aH7vm', '', NULL, NULL, NULL, 'mic4126@gmail.com'),
	('admin1', 'admin1', 'nimda', 'admin', '$2a$10$038HL8V.Znv/ualSNQw1POOMrrRHT/9Fy2Rgc2dGUNCSq0pHIeuKG', '', NULL, NULL, NULL, 'mic4126@gmail.com'),
	('admin10', 'admin', 'admin', 'admin', '$2a$10$wp7gzeOpZqKRyRtmkMnuPuc7nFzZYhBLIM2iRYpSv46v3ozZmshi2', '', NULL, NULL, NULL, 'mic4126@gmail.com'),
	...
	('admin5', 'admin', 'nimda', 'admin', '$2a$10$038HL8V.Znv/ualSNQw1POOMrrRHT/9Fy2Rgc2dGUNCSq0pHIeuKG', '', '$2a$10$PmPHONYJFYX8kHn9D1u3lOYWaKqfZOrwvK0bIpcfzxpaXI5PtRGQO', '', '2022-01-10 03:08:37', 'mic4126@gmail.com'),
	('admin99', 'admin1', 'nimda', 'admin', '$2a$10$e5tMw.Tq5Z7exobV3OFGC.Tip28TyLorcN4hOdfbZkEue63MiH/rO', '', NULL, NULL, NULL, 'mic4126@gmail.com'),
	('dev', 'admin1', 'admin', 'dev', '$2a$10$/i/wKF6oWHIuJE1of6KrDeMpYw12nEzw1C0MgxFpxbokQD3pnl55G', '', NULL, NULL, NULL, 'mic4126@gmail.com'),
...
-- 傾印  觸發器 airegistry.AttachmentProjectIDCheckTrigger 結構
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
